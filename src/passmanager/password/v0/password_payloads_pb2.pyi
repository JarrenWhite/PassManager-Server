...
class PasswordStartResponse(_message.Message):
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["eph_public_b", b"eph_public_b", "master_key_salt", b"master_key_salt", "public_id", b"public_id", "srp_salt", b"srp_salt", "username_hash", b"username_hash"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
