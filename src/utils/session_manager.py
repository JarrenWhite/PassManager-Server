...
class SessionManager():
    ...
    def open_session(
    ...
    ) -> Tuple[bool, List[Error], bytes, int, int]:
        """
        ...
        if not success:
            ...
            return False, [failure_reason.error_proto()], b'', 0, 0
        ...
        return True, [], decrypted_data, user_id, session_id
