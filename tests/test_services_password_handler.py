...
class TestStart():
    ...
    def setup_teardown(self, monkeypatch):
        ...
        self.start_password_session_response = True, None, "fake_public_id", b'fake_eph_public_b', b'fake_srp_salt', b'fake_master_key_salt'
    ...
    def test_username_hash_not_matching(self):
        ...
        assert len(self.start_password_session_called) == 0
    ...
    def test_calls_convert_to_proto(self):
        ...
        assert serialize_to_string.master_key_salt == b'fake_master_key_salt'
...
class TestAuth():
    ...
    def test_username_hash_not_matching(self):
        ...
        assert len(self.auth_password_session_called) == 0
...
class TestCommit():
    ...
    def test_username_hash_not_matching(self):
        ...
        assert len(self.commit_called) == 0
...
class TestAbort():
    ...
    def setup_teardown(self, monkeypatch):
        ...
        def fake_serialize_to_string(input):
            self.serialize_to_string_called.append(input)
            return self.serialize_to_string_response
        monkeypatch.setattr(PasswordAbortResponse, "SerializeToString", fake_serialize_to_string)
    ...
    def test_username_hash_not_matching(self):
        ...
        assert len(self.abort_called) == 0
    ...
    def test_returns_error_util_call_fails(self, failure_reason, field):
        ...
        self.abort_response = False, failure_reason
    ...
    def test_calls_convert_to_proto(self):
        ...
        serialize_to_string = self.serialize_to_string_called[0]
        assert isinstance(serialize_to_string, PasswordAbortResponse)
        assert serialize_to_string.username_hash == b'fake_username_hash'
...
class TestGet():
    """Test cases for password get function"""
    ...
    def setup_teardown(self, monkeypatch):
        ...
        self.from_string_called = []
        self.from_string_response = PasswordGetRequest(
            username_hash=b'fake_username_hash'
        )
        self.from_string_exception = False
        def fake_from_string(data):
            ...
            if self.from_string_exception:
                ...
                return self.from_string_response
        monkeypatch.setattr(PasswordGetRequest, "FromString", fake_from_string)
        ...
        def fake_serialize_to_string(input):
            self.serialize_to_string_called.append(input)
            return self.serialize_to_string_response
        monkeypatch.setattr(PasswordGetResponse, "SerializeToString", fake_serialize_to_string)
    ...
    def test_returns_error_util_call_fails(self, failure_reason, field):
        ...
        self.get_entry_response = False, failure_reason, b'fake_entry_name', b'fake_entry_data'
...
class TestUpdate():
    """Test cases for password update function"""
    ...
    def test_username_hash_not_matching(self):
        ...
        assert len(self.update_called) == 0
    ...
    def test_returns_error_util_call_fails(self, failure_reason, field):
        ...
        self.update_response = False, failure_reason
