...
class TestStart():
    """Test cases for the Session Start API endpoint"""
...
class TestAuth():
    """Test cases for the Session Auth API endpoint"""
...
class TestDelete():
    """Test cases for the Session Delete API endpoint"""
...
class TestClean():
    """Test cases for the Session Clean API endpoint"""
    ...
    def test_call_frontend(self, monkeypatch):
        ...
        def fake_service_handler(data: Dict[str, Any]):
            ...
            called["data"] = data
            return {"false_key": "false_data"}, 546
        monkeypatch.setattr(ServiceSession, "clean", fake_service_handler)
    ...
    def test_no_json_content(self, monkeypatch):
        ...
        response = self.client.post('/api/session/clean')
