...
class TestRegister():
    """Test cases for the User Register API endpoint"""
...
class TestUsername():
    """Test cases for the User Username API endpoint"""
    ...
    def test_call_frontend(self, monkeypatch):
        ...
        def fake_service_handler(data: Dict[str, Any]):
            ...
            called["data"] = data
            return {"false_key": "false_data"}, 546
        monkeypatch.setattr(ServiceUser, "username", fake_service_handler)
    ...
    def test_no_json_content(self, monkeypatch):
        ...
        response = self.client.post('/api/user/username')
...
class TestDelete():
    ...
    def test_call_frontend(self, monkeypatch):
        ...
        def fake_service_handler(data: Dict[str, Any]):
            ...
            called["data"] = data
            return {"false_key": "false_data"}, 546
        monkeypatch.setattr(ServiceUser, "delete", fake_service_handler)
