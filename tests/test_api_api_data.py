...
class TestEdit():
    """Test cases for the Data Edit API endpoint"""
    ...
    def test_call_frontend(self, monkeypatch):
        ...
        def fake_service_handler(data: Dict[str, Any]):
            ...
            called["data"] = data
            return {"false_key": "false_data"}, 546
        monkeypatch.setattr(ServiceData, "edit", fake_service_handler)
    ...
    def test_no_json_content(self, monkeypatch):
        ...
        response = self.client.post('/api/data/edit')
...
class TestDelete():
    """Test cases for the Data Delete API endpoint"""
    ...
    def test_call_frontend(self, monkeypatch):
        ...
        def fake_service_handler(data: Dict[str, Any]):
            ...
            called["data"] = data
            return {"false_key": "false_data"}, 546
        monkeypatch.setattr(ServiceData, "delete", fake_service_handler)
...
class TestGet():
    """Test cases for the Data Get API endpoint"""
    ...
    def test_call_frontend(self, monkeypatch):
        ...
        def fake_service_handler(data: Dict[str, Any]):
            ...
            called["data"] = data
            return {"false_key": "false_data"}, 546
        monkeypatch.setattr(ServiceData, "get", fake_service_handler)
    ...
    def test_no_json_content(self, monkeypatch):
        ...
        response = self.client.post('/api/data/get')
